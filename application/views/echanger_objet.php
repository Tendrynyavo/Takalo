    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Choisissez votre objet</h1>
                <p class="lead fw-normal text-white-50 mb-0">Confirmez votre échange</p>
            </div>
        </div>
    </header>
        ...
        <div class="container px-4 px-lg-5 mt-5">
            ...
            <!-- Anazy -->
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="<?= base_url('assets/img/basket.png') ?>" alt="..." width="284px" height="177px"/>
                        <!-- Product details-->
            ...
            <!-- Anao -->
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="<?= base_url('assets/img/macbook.png') ?>" alt="..."  width="284px" height="177px"/>
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                            ...
                            <form action="post" action="#" class="text-center">
                                <select class="selectpicker">
                                    <option selected>Choisissez un objet</option>
                                    <optgroup label="Akanjo">
                                        <option>Costard</option>
                                        <option>Short</option>
                                    </optgroup>
                                    <optgroup label="Kilalao">
                                        <option>Baolina</option>
                                        <option>Kanety</option>
                                    </optgroup>
                                    <optgroup label="Boky">
                                        <option>Le docteur amoureux</option>
                                        <option>Doctor Sleep</option>
                                    </optgroup>
                                </select>
