...
('Stone', 'Bob', 'bob@gmail.com', '1234', 0),
('Platini', 'Michel', 'mp@gmail.com', 'abcd', 0),
('Noa', 'Yanick', 'yn@gmail.com', '300$', 0);

INSERT INTO objet(idUser, nom, idCategorie, descr, prix, etat) VALUES
(5, 'Le Docteur Amoureux', 2, 'Un petit Molière', 2000.00, 0),
(4, 'Nike', 4, 'Un petit Molière', 200.00, 0),
(4, 'Devil May Cry 5', 4, 'Ts mandeha fa tsara boîte', 25000.00, 0),
(4, 'Converses', 4, 'Noires', 150.00, 0),
(6, 'T-shirt Spider-Man', 3, 'Il pu', 2000.00, 0),
(6, 'Huawei nova 2', 4, 'Bon état', 325000.00, 0),
(4, 'Souris Gamer', 4, 'Noire et verte, sans néons', 12000.00, 0),
(5, 'Shining', 4, 'Un livre de Stephen King', 2000.00, 0),
(4, 'Doctor Sleep', 4, 'Shining, la suite', 2300.00, 0),
(4, 'GTA V', 4, 'PS3', 15000.00, 0);
